...
cats.set("Books, Sports & Hobbies",12);
cats.set("Books & Magazines",62);
cats.set("Musical Instruments",63);
cats.set("Sports Equipment",64);
cats.set("Gym & Fitness",65);
cats.set("Other Hobbies",66);
...
var urlE = 'https://www.olx.com.pk/books-sports-hobbies/?page=';
spider.url('https://www.olx.com.pk/books-sports-hobbies/');
...
function mysqlPostData(href,imgUrl,cat){
    ...
    connection.query('INSERT INTO table_books_sports_hobbies SET ?', href_post, function (error, results) {
        if(!error){
