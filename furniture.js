...
cats.set("Furniture & Home Decor",10);
cats.set("Sofa & Chairs",44);
cats.set("Beds & Wardrobes",45);
cats.set("Home Decor",46);
cats.set("Tables & Dining",47);
cats.set("Painting & Mirrors",48);
cats.set("Curtains & Blinds",49);
cats.set("Rugs & Carpets",50);
cats.set("Garden & Outdoor",51);
cats.set("Other Household Items",52);
...
var urlE = 'https://www.olx.com.pk/furniture-home-decor/?page=';
spider.url('https://www.olx.com.pk/furniture-home-decor/');
...
function mysqlPostData(href,imgUrl,cat){    
    ...
    connection.query('INSERT INTO table_furniture_home_decor SET ?', href_post, function (error, results) {
        if(!error){
